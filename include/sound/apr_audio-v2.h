...
#define MODULE_ID_PP_SS_SB_4SPK_1 0x10001f00
#define MODULE_ID_PP_SS_SB_4SPK_2 0x10001f01
#define AUDPROC_PARAM_ID_PP_SB_PARAM            0x10001f04
#define AUDPROC_PARAM_ID_PP_SB_ROTATION_PARAM   0x10001f02
...
struct adm_set_pp_sb_rotation_param {
	struct adm_cmd_set_pp_params_v5 command;
	struct adm_param_data_v5 params;
	u32    sb_rotaion;
} __packed;
